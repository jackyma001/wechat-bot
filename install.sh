...
sed -i "s/export const botName = ''/export const botName = '$bot_name'/g" config.js
...
sed -i "s/export const roomWhiteList = \[\]/export const roomWhiteList = \[$room_white_list\]/g" config.js
...
sed -i "s/export const aliasWhiteList = \[\]/export const aliasWhiteList = \[$alias_white_list\]/g" config.js
